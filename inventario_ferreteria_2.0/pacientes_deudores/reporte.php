...
return $nl;
	...
	$this->Cell(15,8,date("Y"),1,1,'C');
		$this->Ln(15);
			$this->SetFont('Arial','B', 15);
	$this->Cell(80);
	$this->Cell(30,10,"PACIENTES DEUDORES" ,0,1,'C');
	$this->Cell(80);
...
$pdf->Cell(25,6,utf8_decode($row['ci']),1,0,'L');
$pdf->Cell(25,6,utf8_decode($row['costo']),1,0,'R');
$pdf->Cell(20,6,utf8_decode($row['pagado']),1,0,'R');
$pdf->Cell(20,6,utf8_decode($row['saldo']),1,1,'R');
