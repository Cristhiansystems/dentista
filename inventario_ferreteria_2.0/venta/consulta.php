...
include ("../conexion.php");
	...
	$html=" ";
	$registros=$base->query("Select * From venta INNER JOIN cliente on cliente.id_cliente=venta.id_cliente where venta.estado='activo' and venta.tipo='Venta' order by id_venta")->fetchAll(PDO::FETCH_OBJ);
