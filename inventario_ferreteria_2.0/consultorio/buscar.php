...
$pagina=isset($_POST['pagina'])? (int)$_POST['pagina']:1;
	...
	$registros=$base->query("SELECT SQL_CALC_FOUND_ROWS cons.id_consultorio, cons.nombre as consultorio, age.nombre as agencia FROM tbl_consultorios cons INNER JOIN tbl_agencias age on cons.id_agencia=age.id_agencia  where cons.estado='$estado' and cons.nombre like '%$busc_empl%' or cons.estado='$estado' and  age.nombre like '%$busc_empl%'  order by  cons.id_consultorio limit $inicio , $regpagina")->fetchAll(PDO::FETCH_OBJ);
