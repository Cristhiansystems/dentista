...
function borrarest(event){
							        swal({
			  title: "¿ESTA SEGUR@ QUE DESEA ELIMINAR EL SEGURO MEDICO?",
			  type: "warning",
			  ...
			  closeOnConfirm: false
				...
				function(){
								...
								$.post("borrar.php", { ide: ide }, function(data){
									...
									swal("SE HA ELIMINADO EL SEGURO MEDICO CORRECTAMENTE", "","success");
									estado="activo";
									consulta(estado);
...
function rest(id2){
		swal({
  title: "¿ESTA SEGUR@ QUE DESEA RESTAURAR EL SEGURO MEDICO?",
  type: "warning",
  showCancelButton: true,
  confirmButtonColor: "#DD6B55",
                ...
                <div class="box-body">
	                ...
	                <?php
							...
							?>
									...
									<h1 align="center">LISTA DE SEGUROS MEDICOS</h1>
