...
$estado=$_POST['estado'];
	...
	$html="";
	$registros=$base->query("SELECT SQL_CALC_FOUND_ROWS * FROM tbl_aseguradoras where estado='$estado' order by nombre limit $inicio , $regpagina")->fetchAll(PDO::FETCH_OBJ);
