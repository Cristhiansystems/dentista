...
$(document).ready(function(){
	...
	function buscarconsulta(criterio,nropagina,tipoestado){
		...
		//Mostrar los empleados desactivados
		$("#des").click(function(){
				if($("#tipo").val()=="activo"){
				//	$("#tipo").val("desactivo");
				//	consulta($("#tipo").val());
...
function borrarest(event){
							        swal({
			  title: "¿ESTA SEGUR@ QUE DESEA ELIMINAR LA AGENCIA?",
			  type: "warning",
			  ...
			  closeOnConfirm: false
				...
				function(){
								...
								$.post("borrar.php", { ide: ide }, function(data){
									...
									swal("SE HA ELIMINADO LA AGENCIA CORRECTAMENTE", "","success");
									estado="activo";
									consulta(estado);
...
function rest(id2){
		swal({
  title: "¿ESTA SEGUR@ QUE DESEA RESTAURAR LA AGENCIA?",
  type: "warning",
  showCancelButton: true,
  confirmButtonColor: "#DD6B55",
