...
include ("../conexion.php");
	...
	$registros=$base->query("SELECT  SQL_CALC_FOUND_ROWS * FROM tbl_agencias where estado='$estado' and nombre like '%$busc_empl%' or  estado='$estado' and direccion like '%$busc_empl%' order by nombre limit $inicio , $regpagina")->fetchAll(PDO::FETCH_OBJ);
