...
function borrarest(event){
							        swal({
			  title: "¿ESTA SEGUR@ QUE DESEA ELIMINAR AL CLIENTE?",
			  type: "warning",
			  ...
			  closeOnConfirm: false
				...
				function(){
								...
								$.post("borrar.php", { ide: ide, tip:tip}, function(data){
																			
									swal("SE HA ELIMINADO AL CLIENTE CORRECTAMENTE", "","success");
									estado="activo";
									consulta(estado);
									//$("#tabla").html(data);
									controlarClick();
...
function mensaje(){
	swal("SE HA REGISTRADO EL PARTICIPANTE CON EXITO","","success");
	
	}
	function res(i){
	var it=i;
	swal("SE HA RESTAURADO EL PARTICIPANTE CON EL ID " + it ,"","success");
