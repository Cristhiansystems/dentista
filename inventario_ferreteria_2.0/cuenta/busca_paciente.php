...
$dato = $_POST['dato'];
$registro = $base->query("SELECT codigo,concat(nombre,' ',apellido_paterno,' ',apellido_materno) as paciente ,ci,id_paciente FROM tbl_pacientes where concat(nombre ,' ',apellido_paterno) LIKE '%$dato%' ORDER BY id_paciente ASC");
