...
function borrarest(event){
							        swal({
			  title: "¿ESTA SEGUR@ QUE DESEA ELIMINAR LA PIEZA DENTAL?",
			  type: "warning",
...
function rest(id2){
		swal({
  title: "¿ESTA SEGUR@ QUE DESEA RESTAURAR LA PIEZA DENTAL?",
  type: "warning",
  showCancelButton: true,
  confirmButtonColor: "#DD6B55",
...
<h1 align="center">LISTA DE PIEZAS DENTALES</h1>
