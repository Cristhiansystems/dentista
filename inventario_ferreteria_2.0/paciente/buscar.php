 ...
 if($Totalregistros>=1):
        $html.="<nav aria-label='Page navigation' class='text-right'>
                    <ul class='pagination'>";
                        ...
                        $html.="<li>    
                                    <a id='btnpag' href='#' data=".($pagina-1)." aria-label='Previous'>
                                        <span aria-hidden='true'>&laquo;</span>
                                    </a>
                                </li>";
                        endif;
                   ...
                   $html.="
                        <li class='disabled'>
                            <a href='#' aria-label='Next'>
                              ...
                              $html.="
                        <li>
                            <a id='btnpag' href='#' data=".($pagina+1)." aria-label='Next'>
                                <span aria-hidden='true'>&raquo;</span>
                            </a>
                        </li>";
                    endif;
